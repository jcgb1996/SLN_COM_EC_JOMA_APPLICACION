...
namespace SLN_COM_EC_JOMA_APPLICACION.Areas.Inicio.Controllers
{
    ...
    public class LoginController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ControlerName = $"{WebSiteConstans.JOMA_WEBSITE_AREA_INICIO}/{WebSiteConstans.JOMA_WEBSITE_AREA_INICIO_CONTROLLER_LOGIN}";
            return View();
        }
        [HttpPost]
        public async Task<IActionResult> RealizarLogin([FromBody] LoginReqAppDto DatosLogin)
        {
            try
            {
                ...
                {
                    string redirectUrl = Url.Action(WebSiteConstans.JOMA_WEBSITE_ACCION_INDEX, WebSiteConstans.JOMA_WEBSITE_AREA_INICIO_CONTROLLER_DASHBOARD, new { area = WebSiteConstans.JOMA_WEBSITE_AREA_INICIO });
        ...
        public IActionResult CerrarSesion()
        {
            ...
            string redirectUrl = Url.Action(WebSiteConstans.JOMA_WEBSITE_ACCION_INDEX, WebSiteConstans.JOMA_WEBSITE_AREA_INICIO_CONTROLLER_LOGIN, new { area = WebSiteConstans.JOMA_WEBSITE_AREA_INICIO });
            return StatusCode(StatusCodes.Status200OK, redirectUrl);
        }
